...
<template>
  ...
  >
    ...
    >
      <Music class="w-10 h-10 opacity-50 mb-3" stroke-width="1.5" />
      <span class="text-sm">No audio selected</span>
    </div>
    ...
    >
      ...
      >
        ...
        >
          <Loader2
            class="w-10 h-10 text-[var(--vtip-code-function)] animate-spin mb-3"
            stroke-width="2"
          />
        ...
        >
          <button
            type="button"
            :class="[
              'vtip-btn flex flex-col gap-3 shrink-0',
