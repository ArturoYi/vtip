...
const content = ref('<p>Hello <strong>Tiptap</strong>!</p><img src="https://placehold.co/600x400" width="50%" align="center"><div data-type="image-placeholder"></div><pre><code></code></pre><p></p>')
